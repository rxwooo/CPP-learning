...
int main(int argc, char *argv[]) {
	...
	const char *sysy_file_path = "D:\\CodeWarehouse\\C-CPP\\study\\PrincipleOfCompile\\test.txt";
	const char *output_file_path = "D:\\CodeWarehouse\\C-CPP\\study\\PrincipleOfCompile\\result.txt";;
	int optimize = 0;
	// --argc;
	// ++argv;
